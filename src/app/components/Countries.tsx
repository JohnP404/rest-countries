...
export default async function Countries() {
    // const res = await fetch(`${process.env.LOCAL_SOURCE_URL}/all`);
    ...
    return (
        <div className="py-4 px-8 grid grid-cols-1 gap-y-8 md:grid-cols-2 md:gap-20 lg:grid-cols-3 xl:grid-cols-4 mt-8">
            {dummy.map((country) => (
