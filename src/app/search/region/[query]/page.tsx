...
export default async function Countries({
    ...
    const res = await fetch(
        `${process.env.LOCAL_SOURCE_URL}/filter?region=${params.query}`
    );
    ...
    return (
        <div className="grid grid-cols-1 gap-y-8 md:grid-cols-2 md:gap-20 lg:grid-cols-3 xl:grid-cols-4 mt-8">
            {data.map((country) => (
